...
def upcoming():
    ...
    movie1 = Image.open(r"thumb-1920-1159896.jpg")
    ...
    movie2 = Image.open(r"thor_love_and_thunder_fanart_2021_4k_hd_thor_love_and_thunder.jpg")
...
movie1 = Image.open(r'052421_Eternals-teaser_01.jpg')
movie1 = movie1.resize((192, 108))
testmovie1 = ImageTk.PhotoImage(movie1)
...
movie2 = Image.open(r"Venom-Let-There-Be-Carnage-Featured-New.jpg")
movie2 = movie2.resize((192, 108))
testmovie2 = ImageTk.PhotoImage(movie2)
...
movie3 = Image.open(r"Shang-Chi-And-The-Legend-Of-The-Ten-Rings-Header-2.jpg")
movie3 = movie3.resize((192, 108))
testmovie3 = ImageTk.PhotoImage(movie3)
